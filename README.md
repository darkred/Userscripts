...
- [IMDb User Reviews pages - as many star icons as the ratings](https://github.com/darkred/Userscripts/tree/master/IMDb_User_Reviews_pages_-_as_many_star_icons_as_the_ratings#readme) In IMDb User Reviews pages, display as many star icons as the ratings (in yellow) compared to the max rating, 10 (in black).
